...
public class TeiidEmbeddedSparkDataSource {
	...
	public static void main(String[] args) throws Exception {
		...
		server.deployVDB(TeiidEmbeddedSparkDataSource.class.getClassLoader().getResourceAsStream("hive-vdb.xml"));
		
		Connection c = server.getDriver().connect("jdbc:teiid:hivevdb", null);
		
		execute(c, "SELECT * FROM FOO", false);
		
		execute(c, "SHOW DATABASES", true);
